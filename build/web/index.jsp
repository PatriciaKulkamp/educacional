...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta name="description" content="Trabalho Desenvolvimento Web II">
            <meta name="author" content="Patrícia Külkamp">
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a class="brand" href="#">GESTÃO EDUCACIONAL</a>
       ...
       <footer style="color:#FFF;background-color:#000; padding:3px;font-size:0.9em">
            <p align="center">&copy; Patrícia Kulkamp 2015 - Sistemas de Informação<br>
            <a href="http://www.unidavi.edu.br">www.unidavi.edu.br</a> - Gestão Educacional</p>
      </footer>
